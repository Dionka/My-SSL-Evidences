...
rgrep "SSLv2" | grep "Accepted\|Preferred" | cut -f1 -d " "  | sed "s/ssl_results_//g" | sed "s/sslscan.txt:Accepted//g" | sed "s/sslscan.txt:/ /g" | sed "s/Preferred//g"  | tr -d / | tr _ : | sort | uniq > "results/sslv2.txt"

rgrep "SSLv3" | grep "Accepted\|Preferred" | cut -f1 -d " "  | sed "s/ssl_results_//g" | sed "s/sslscan.txt:Accepted//g" | sed "s/sslscan.txt:/ /g" | sed "s/Preferred//g"  | tr -d / | tr _ : | sort | uniq > "results/sslv3.txt"
